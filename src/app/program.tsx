...
const program: Record<string, ScheduleItem[]> = {
  ...
  "VIERNES 10": [
    ...
    { time: "11:15", activity: "Break" },
    {
      ...
      activity: "Plenaria 3",
      enabled: true,
       plenaryName: "Pon tu mano aquí",
       speaker: "VOM",
       downloadUrl: "https://drive.google.com/file/d/15-gLkSqGgaK-qX2RuL_svUZ9VE7LIzVc/view?usp=sharing",
    },
  ...
  "SÁBADO 11": [
    ...
    { time: "19:00", activity: "Adoración" },
    {
      ...
      activity: "Plenaria 7",
      enabled: true,
      plenaryName: "Y entonces vendrá el fin...",
      speaker: "Marcos Brunet",
      downloadUrl: "https://drive.google.com/file/d/158gmN8EeeN3_ATA21YAgZuFzW5UGgzib/view?usp=drive_link",
    },
    { time: "21:30", activity: "Cierre" },
  ],
};
